 ...
 *	Author: Aliya
 *  Date: 9/18/26
 * 	Collaborator: Nisha, Ashley, Jayden
 * ================================================================
...
public class starter {
    ...
    public static void main(String[] args) {
        ...
        double number=Math.pow(rizzPower,2);
        double number2=Math.pow(sigmaSpeed,2);
        double number3=Math.pow(brainrotEnergy,2);
        double heroPower=(double)(Math.sqrt(number+number2+number3));
        ...
        double fateRoll=(double)(Math.random()+0.5*1.5);
